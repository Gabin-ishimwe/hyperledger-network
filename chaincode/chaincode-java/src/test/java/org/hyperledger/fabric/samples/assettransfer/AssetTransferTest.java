...
public final class AssetTransferTest {
    ...
    class InvokeCreateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.CreateAsset(ctx, "asset1", "blue", 45, "Siobhan", 60);
            });
        ...
        public void whenAssetDoesNotExist() {
            ...
            Asset asset = contract.CreateAsset(ctx, "asset1", "blue", 45, "Siobhan", 60);

            assertThat(asset).isEqualTo(new Asset("asset1", "blue", 45, "Siobhan", 60));
        }
    }
